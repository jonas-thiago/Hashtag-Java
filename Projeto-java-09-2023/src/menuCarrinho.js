...
function removerDoCarinho(idProduto) {
...
function desenharProdutoNoCarrinho(idProduto) {
  ...
  const cartaoProdutoCarrinho = `<button id="remover-item-${
    ...
    <img src="./assets/img/${produto.imagem}" alt="Carinho: ${
    produto.nome
  ...
  document
    ...
    .addEventListener("click", () => removerDoCarinho(produto.id));
}
